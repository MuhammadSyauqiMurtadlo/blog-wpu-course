...
<div class="min-h-full">
  <nav class="bg-gray-800/50" x-data="{ isOpen: false, isProfileOpen: false }">
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <p class="mt-2 text-lg text-gray-300">Learn more about our mission, values, and the team behind our success.</p>
    </div>
  </main>
</div>
